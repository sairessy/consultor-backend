...
app.post("/update", (req, res) => {
  const data = req.body;
  const {email, name, birthday, province, zone, course, profileIsPublic, tel, desc, interrests, gender, profession, user} = data;

  collections.users.update({ _id: user }, {
    $set: {
      email, name, birthday, province, zone, course, profileIsPublic, tel, desc, interrests, gender, profession,
      profileUpdated: true
    }
